...
\begin{itemize}[nosep]
  ...
  \item \textbf{Black-hole shadows.} In the strong-field regime the
    ...
    see \texttt{KNOWN\_ISSUES.md} 2026-04-25 M9.1$''$ P3). The tensor
    sector is now closed via OP-7 (94/97 = 96.9\% PASS, 2026-04-25);
    OP-EHT remains open and is independent of OP-7. Ref.~\cite{TGP-BH}
    reports the weak-field photon-ring estimate from the v1 exponential
    ansatz; re-evaluation under~\eqref{eq:exp-metric} is the natural
    next step.
...
\begin{enumerate}[(F1),nosep]
  ...
  \item $\gamma_{\mathrm{PPN}}=\beta_{\mathrm{PPN}}=1$ \emph{at 1PN
    ...
    OP-EHT, still open) would falsify the substrate-potential ansatz.
