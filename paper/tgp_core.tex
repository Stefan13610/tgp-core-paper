...
OP-9 & Strong-field black-hole solutions
  ...
  conditional pivot deferred to ngEHT 2030+ verdict.
  See \texttt{research/op-eht/OP\_EHT\_final\_verdict.md},
  \texttt{research/op-eht-A/OP\_EHT\_A\_final\_verdict.md}, and
  \texttt{KNOWN\_ISSUES.md}.
  & \textsf{HY}\\
...
\begin{itemize}[nosep]
  ...
  \item \textbf{Black-hole shadows.} In the strong-field regime the
    ...
    (M9.2 conditional pivot, deferred); pending that, M9.1$''$ remains
    a \emph{falsifiable} strong-field prediction with the $+14.56\%$
    Sgr A$^*$ shadow as a binary test against ngEHT.
...
\begin{enumerate}[(F1),nosep]
  ...
  \item $\gamma_{\mathrm{PPN}}=\beta_{\mathrm{PPN}}=1$ \emph{at 1PN
    ...
    Sgr A$^*$) would falsify the substrate-potential ansatz.
