...
OP-7 & Tensor projection $\sigma_{ab}$
  ...
  \texttt{TGP\_CLOSURE\_PLAN\_2026-04-25.md}.
  & \textsf{HY}\\
...
OP-9 & Strong-field black-hole solutions
  ...
  readiness package, 2026-04-25)}: T-M92.1 reverse-engineer
...
\begin{enumerate}[(F1),nosep]
  ...
  \item $\gamma_{\mathrm{PPN}}=\beta_{\mathrm{PPN}}=1$ \emph{at 1PN
    ...
    readiness package 2026-04-25) would falsify the substrate-potential
    ansatz.
